...
srun python3 nbm_main.py config/nbm/gta3/gta3_d5_l4.json --force_regenerate --force_reload --seed 0
srun python3 nbm_main.py config/nbm/gta3/gta3_d5_l4.json --force_regenerate --force_reload --seed 1
srun python3 nbm_main.py config/nbm/gta3/gta3_d5_l4.json --force_regenerate --force_reload --seed 2
